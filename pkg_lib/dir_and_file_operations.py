...
if __name__ == "__main__":
    ...
    runningScriptDir = os.path.dirname(os.path.abspath(__file__))
    print(get_full_folder_path(get_full_folder_path(runningScriptDir)))
    print(get_full_folder_path(runningScriptDir))
    print(list_of_base_filenames(runningScriptDir))
